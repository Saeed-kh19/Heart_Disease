"""
src/config.py
Central configuration for preprocessing, experiments, and reproducibility.
Edit values here to change dataset paths, preprocessing variants, model grid, and evaluation settings.
"""
